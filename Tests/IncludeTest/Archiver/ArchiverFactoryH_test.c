...
void TestArchiverFactory_CInterface(IArchiverFactory* pArchiverFactory)
{
    ...
    IArchiverFactory_RemoveDeviceData(pArchiverFactory, (IArchive*)NULL, ARCHIVED_DEVICE_TYPE_FLAG_NONE, (IFileStream*)NULL);
    IArchiverFactory_AppendDeviceData(pArchiverFactory, (IArchive*)NULL, ARCHIVED_DEVICE_TYPE_FLAG_NONE, (IArchive*)NULL, (IFileStream*)NULL);
