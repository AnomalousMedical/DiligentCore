...
void SetupWithSpirvVersion(::glslang::TShader& Shader,
                           ...
                           bool                InputHLSL)
{
    const auto ShSource = InputHLSL ? ::glslang::EShSourceHlsl : ::glslang::EShSourceGlsl;
                                      ...
                                      IDataBlob**             ppCompilerOutput)
{
    ...
    SetupWithSpirvVersion(Shader, spvTarget, shProfile, ShLang, Version, true);
...
std::vector<unsigned int> GLSLtoSPIRV(const GLSLtoSPIRVAttribs& Attribs)
{
    ...
    SetupWithSpirvVersion(Shader, spvTarget, shProfile, ShLang, Attribs.Version, false);
