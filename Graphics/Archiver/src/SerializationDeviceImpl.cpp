    ...
    m_AdapterInfo{CreateInfo.AdapterInfo}
{
...
#if GL_SUPPORTED
    m_DeviceFlags = m_DeviceFlags | ARCHIVED_DEVICE_TYPE_FLAG_GL;
#endif
#if GLES_SUPPORTED
    m_DeviceFlags = m_DeviceFlags | ARCHIVED_DEVICE_TYPE_FLAG_GLES;
#endif

#if D3D11_SUPPORTED
    m_D3D11FeatureLevel = CreateInfo.D3D11.FeatureLevel;
    m_DeviceFlags       = m_DeviceFlags | ARCHIVED_DEVICE_TYPE_FLAG_D3D11;
#endif
    ...
    m_DeviceFlags        = m_DeviceFlags | ARCHIVED_DEVICE_TYPE_FLAG_D3D12;
#endif
    ...
    m_DeviceFlags        = m_DeviceFlags | ARCHIVED_DEVICE_TYPE_FLAG_VULKAN;
#endif
    ...
    if (CreateInfo.Metal.CompileForMacOS)
    {
        ...
        m_DeviceFlags            = m_DeviceFlags | ARCHIVED_DEVICE_TYPE_FLAG_METAL_MACOS;
    }
    if (CreateInfo.Metal.CompileForiOS)
    {
        ...
        m_DeviceFlags          = m_DeviceFlags | ARCHIVED_DEVICE_TYPE_FLAG_METAL_IOS;
    }
#endif
}
